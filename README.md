...
| Server integration                         | 900                                  | Real PostgreSQL + MongoDB — server actions, queries, auth, audit hash chain, rate limiting, health, sessions              |
...
| **Total**                                  | **2910** (2835 Jest + 75 Playwright) | **92.2% line coverage · 92.0% function coverage**                                                                         |
