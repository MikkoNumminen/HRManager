...
-- AddForeignKey
ALTER TABLE "Department" ADD CONSTRAINT "Department_headId_fkey" FOREIGN KEY ("headId") REFERENCES "Person"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Team" ADD CONSTRAINT "Team_teamManagerId_fkey" FOREIGN KEY ("teamManagerId") REFERENCES "Person"("id") ON DELETE SET NULL ON UPDATE CASCADE;
